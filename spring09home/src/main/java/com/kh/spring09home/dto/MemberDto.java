...
public class MemberDto 
{
	...
	public String toString() {
		return "MemberDto [memberId=" + memberId + ", memberPw=" + memberPw + ", memberNickname=" + memberNickname
				+ ", memberBirth=" + memberBirth + ", memberContact=" + memberContact + ", memberEmail=" + memberEmail
				+ ", memberLevel=" + memberLevel + ", memberPoint=" + memberPoint + ", memberPost=" + memberPost
				+ ", memberAddress1=" + memberAddress1 + ", memberAddress2=" + memberAddress2 + ", memberJoin="
				+ memberJoin + ", memberLogin=" + memberLogin + ", memberChange=" + memberChange + "]";
	}
}