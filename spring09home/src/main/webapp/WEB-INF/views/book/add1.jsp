...
<input type = "text" name = "bookPublicationDate" placeholder = "책 입력하세요.">
<input type = "number" name = "bookPrice" placeholder = "책 가격을 입력하세요.">
<input type = "number" name = "bookPageCount" placeholder = "책 페이지 수를 입력하세요.">
