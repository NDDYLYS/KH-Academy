...
import com.kh.spring10.configurtion.SpringDocConfiguration;
...
public class TokenRenewalInterceptor implements HandlerInterceptor{
    ...
    private final SpringDocConfiguration springDocConfiguration;
	@Autowired
    ...
    TokenRenewalInterceptor(SpringDocConfiguration springDocConfiguration) {
        this.springDocConfiguration = springDocConfiguration;
    }
